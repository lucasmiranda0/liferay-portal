...
>
	...
	<c:if test="<%= !PasswordPolicyConstants.isUnmodifiable(passwordPolicy.getName()) && !passwordPolicy.getDefaultPolicy() && PasswordPolicyPermissionUtil.contains(permissionChecker, passwordPolicy.getPasswordPolicyId(), ActionKeys.DELETE) %>">
