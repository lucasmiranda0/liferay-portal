...
public class FIPSPortalInstanceLifecycleListenerTest {
	...
	public void test() throws Exception {
		...
		try (SafeCloseable safeCloseable =
			...
			Assert.assertTrue(
				_hasActionId(
					company.getCompanyId(), role.getRoleId(),
					ActionKeys.VERIFY_FIPS_HEALTH));

			_resourcePermissionLocalService.addResourcePermission(
				company.getCompanyId(), PortletKeys.PORTAL,
	...
	private boolean _hasActionId(long companyId, long roleId, String actionId)
		throws Exception {
		...
		return resourcePermission.hasActionId(actionId);
	}
